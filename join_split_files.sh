...
cat product/data-app/Meet/Meet.apk.* 2>/dev/null >> product/data-app/Meet/Meet.apk
rm -f product/data-app/Meet/Meet.apk.* 2>/dev/null
...
cat product/app/MiLinkOS2Global/MiLinkOS2Global.apk.* 2>/dev/null >> product/app/MiLinkOS2Global/MiLinkOS2Global.apk
rm -f product/app/MiLinkOS2Global/MiLinkOS2Global.apk.* 2>/dev/null
...
cat vendor_boot/dtb/10_dtbdump_OZGgZ.dtb.* 2>/dev/null >> vendor_boot/dtb/10_dtbdump_OZGgZ.dtb
rm -f vendor_boot/dtb/10_dtbdump_OZGgZ.dtb.* 2>/dev/null
cat vendor/firmware/vpu20_4v.lst.* 2>/dev/null >> vendor/firmware/vpu20_4v.lst
rm -f vendor/firmware/vpu20_4v.lst.* 2>/dev/null
cat vendor/firmware/vpu20_1v.lst.* 2>/dev/null >> vendor/firmware/vpu20_1v.lst
rm -f vendor/firmware/vpu20_1v.lst.* 2>/dev/null
